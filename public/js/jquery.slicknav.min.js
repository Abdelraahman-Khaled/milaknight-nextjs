  ...
  ((Keyboard = {
    ...
    (o.prototype.init = function () {
      var n,
        ...
        l = this.settings;
      if (
        (l.duplicate ? (i.mobileNav = o.clone()) : (i.mobileNav = o),
        l.removeIds &&
      ...
      ((i.btn = e(
        [
          "<" +
            ...
            s +
            '_collapsed">',
          '<span class="' + s + '_menutxt">' + l.label + "</span>",
          '<span class="' + n + '">',
      ...
      (a && (d = r.duration),
        t.hasClass(s + "_hidden")
          ? (t.removeClass(s + "_hidden"),
            o || r.beforeOpen(i),
            "jquery" === r.animations
              ? t.stop(!0, !0).slideDown(d, r.easingOpen, function () {
                  p(i, n);
                })
          ...
          : (t.addClass(s + "_hidden"),
            ...
            "jquery" === r.animations
              ? t
                  .stop(!0, !0)
                  .slideUp(d, this.settings.easingClose, function () {
                    u(i, n);
                  })
              : "velocity" === r.animations &&

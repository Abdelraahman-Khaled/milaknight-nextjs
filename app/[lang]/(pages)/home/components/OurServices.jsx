            ...
            <div className="container">
                ...
                <div className="services-row">
                    {content.services.map((service, index) => (
                        <div key={index} className="service-col">
                            <Link href={`/${language}/${service.href}`} className="service-item">
                ...
                <div className="col-lg-12">
                    <div className="service-footer">
                        <p>
                            {content.footerText}
                            <Link href={`/${language}/pricing`}>{content.footerLinkText}</Link>
                        </p>
                    </div>

                    <div className="text-center mt-4">
                        <div className="section-btn">
                            <Link href={`/${language}/services`} className="btn-default">{content.moreServicesText}</Link>
                        </div>
                    </div>
                </div>
            </div>

        ...
        cards: [
            {
                ...
                text: `خبرتنا متنوعة ضمن مختلف مجالات التسويق الالكتروني لنقدم لكم
                                                ...
                                                واسعة في تصميم استراتيجيات تسويقية مبتكرة تضمن لكم الحضور
                                                القوي والتميّز على جميع المنصات الرقمية والواقعية، في
                                                Milaknight نجتهد لنبتكر من كل فكرة قصة نجاح حقيقية مُلهمة`
            },
            {
                title: "هدفنا",
...
export const servicesData = {
    ar: {
        ...
        sectionSubtitle: "وكالة ",
        sectionSpan: "تسويق ",
        sectionSubtitleEnd: "ترويجية كاملة الخدمات",
        sectionDescription: "تعمل خدماتنا الرقمية على تمكين العلامات التجارية من خلال استراتيجيات وحلول مبتكرة لتحقيق النمو المستدام والمشاركة.",
        services: [
            {
        ...
        footerLinkText: "احصل على عرض أسعار مجاني",
        moreServicesText: "المزيد من الخدمات"
    },
    en: {
        sectionTitle: "Our Services",
        sectionSubtitle: "A full-service",
        sectionSpan: " Marketing Agency",
        sectionDescription: "Our digital services empower brands through innovative strategies and solutions to achieve sustainable growth and engagement.",
        services: [
            {
        ...
        footerLinkText: "Get a Free Quote",
...
export const headerDescriptionData = {
    ar: {
        title: "ماذا نفعل",
        subtitle: "خذ دقيقة واحدة للتحقق من",
        span: "الإنجازات !",
        desc: "فريق الخبراء في Milaknight، أفضل شركة تسويق رقمي."
    },
    en: {
        title: "What We Do",
        subtitle: "Take a minute to check out",
        span: "our Achievements!",
        desc: "Milaknight's team of experts, the best digital marketing company."
    }
}

export const bestWorksData = {
    ar: {
        title: "أبرز أعمالنا",
        subtitle: "خذ دقيقة وألق نظرة على",
        span: " إنجازاتنا!",
        desc: "يقدم فريق الخبراء في Milaknight أفضل شركة تسويق الكتروني، مجموعة متكاملة من الخدمات تشمل العلامات التجارية، إعلانات ممولة، وخدمات تسويق الكتروني متنوعة، نهدف من خلالها إلى مساعدة عملائنا في الوصول إلى جمهورهم المستهدف وتحقيق النتائج المرجوة من خلال خطط تسويقية ذكية، واستراتيجيات إبداعية مبنية على البيانات والتحليل.",
        moreWorks: "المزيد من الأعمال",
        viewText: "عرض"
    },
    en: {
        title: "Our Most Prominent Works",
        subtitle: "Take a minute to check out",
        span: "our Achievements!",
        desc: "Milaknight's team of experts, the best digital marketing company, offers a comprehensive suite of services, including branding, sponsored ads, and various digital marketing services. We aim to help our clients reach their target audience and achieve desired results through smart marketing plans and creative strategies based on data and analysis.",
        moreWorks: "More Works",
        viewText: "View"
    },
    images: Array.from({ length: 12 }, (_, i) => `/images/lastes-work/${i + 1}.webp`)
}

export const testimonialData = {
    ar: {
        title: "اراء العملاء",
        subtitle: "اقرأ ما يقولونه عنا",
        span: "العمل معنا",
        desc: "تعمل خدماتنا الرقمية في شركة تسويق الكتروني Milaknight على تمكين العلامات التجارية من خلال خطط تسويقية مدروسة.",
        counter: "4.9",
        ratingsText: "(5k+ التقييمات)",
        reviewTitle: "تجارب العملاء تتحدث عن نفسها",
        contactBtn: "تواصل معنا",
        items: [
            {
                name: "ميار خالد",
                text: "\"ميلانايت غيرت مفهومنا عن التسويق! شغلهم احترافي ونتائجهم ملموسة من أول حملة\"",
                logo: "/images/icons/trustpilot.svg",
                rating: "/images/icons/stars-5.svg"
            },
            {
                name: "لما سليم",
                text: "\"فريق ميلانايت دائماً متواجد، متعاون، ويقدم حلول مبتكرة تناسب السوق المستهدف\"",
                logo: "/images/icons/google.svg",
                rating: "/images/icons/google-stars.webp"
            },
            {
                name: "كريم عبيد",
                text: "\"واحدة من أفضل وكالات التسويق B2B👌🏻\"",
                logo: "/images/icons/trustpilot.svg",
                rating: "/images/icons/stars-5.svg"
            },
            {
                name: "نوار ساعد",
                text: "\"ميلانايت ساعدونا نطور استراتيجيتنا الرقمية، وكل خطوة معاهم كانت مدروسة\"",
                logo: "/images/icons/google.svg",
                rating: "/images/icons/google-stars.webp"
            },
            {
                name: "ديانا انور",
                text: "\"المحتوى اللي قدموه لنا كان إبداعي ويلامس هوية علامتنا التجارية تمامًا\"",
                logo: "/images/icons/trustpilot.svg",
                rating: "/images/icons/stars-5.svg"
            },
            {
                name: "وحيد المدني",
                text: "\"سوّقوا لنا على السوشيال ميديا بطريقة احترافية، والنتائج كانت رائعة خلال وقت قصير\"",
                logo: "/images/icons/google.svg",
                rating: "/images/icons/google-stars.webp"
            }
        ]
    ...
    en: {
        ...
        subtitle: "Read what they say about",
        span: " working with us",
        desc: "Our digital services at Milaknight Digital Marketing empower brands through thoughtful marketing plans and innovative digital marketing solutions",
        counter: "4.9",
        ratingsText: "(5k+ Reviews)",
        reviewTitle: "Customer experiences speak for themselves",
        contactBtn: "Contact Us",
        items: [
            {
                name: "Lama Salim",
                text: "\"The Milaknight team is always responsive, collaborative, and provides creative solutions tailored to the target market.\"",
                logo: "/images/icons/trustpilot.svg",
                rating: "/images/icons/stars-5.svg"
            },
            {
                name: "Wahed Madany",
                text: "\"They ran our social media marketing with great professionalism, and we saw excellent results in a short time.\"",
                logo: "/images/icons/google.svg",
                rating: "/images/icons/google-stars.webp"
            },
            {
                name: "Nawar Saed",
                text: "\"Milaknight helped us refine our digital strategy — every step with them was well thought out\"",
                logo: "/images/icons/trustpilot.svg",
                rating: "/images/icons/stars-5.svg"
            },
            {
            ...
            {
                name: "Mudar Draow",
                text: "\"Super lovely company I really enjoyed dealing with them, full listening to my needs and prof achievements.\"",
                logo: "/images/icons/trustpilot.svg",
                rating: "/images/icons/stars-5.svg"
            },
            {
                name: "Nabeel",
                text: "\"A reliable company with great team and alot of services.\"",
                logo: "/images/icons/google.svg",
                rating: "/images/icons/google-stars.webp"
            }
        ]
...
export const latestNewsData = {
    ar: {
        ...
        subtitle: "رؤى حول",
        span: "الابتكار ",
        subtitle_end: "الرقمي والنمو",
        desc: "تعمل خدماتنا الرقمية على تمكين العلامات التجارية من خلال استراتيجيات وحلول مبتكرة لتحقيق النمو المستدام والمشاركة.",
    ...
    en: {
        title: "Latest News",
        subtitle: "Insights into Digital",
        span: " Innovation and Growth ",
        subtitle_end: "",
        desc: "Our digital services empower brands through innovative strategies and solutions to achieve sustainable growth and engagement.",

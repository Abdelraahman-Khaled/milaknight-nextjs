        ...
        <header className="main-header">
            <div className="header-sticky">
                <nav className="navbar navbar-expand-lg">
                    <div className="container-fluid"><Link className="navbar-brand" href="./" style={{ position: 'relative', width: '150px', height: '50px', display: 'block' }}><Image src="/images/logo.svg"
                        alt="Milaknight" fill /></Link>
                        <div className="collapse navbar-collapse main-menu" id="menu">
                            ...
                            <div className="header-social-box d-inline-flex">
                                ...
                                <div className="header-btn"><button className="btn btn-popup" type="button" data-bs-toggle="offcanvas"
                        ...
                        <button className="navbar-toggler slicknav_btn slicknav_collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#menu" aria-controls="menu" aria-expanded="false" aria-label="Toggle navigation">
